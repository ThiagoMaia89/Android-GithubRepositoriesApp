...
class RepoListAdapter : ListAdapter<Repo, RepoListAdapter.ViewHolder>(DiffCallback()) {
    ...
    inner class ViewHolder(
        ...
        fun bind(item: Repo) {
            ...
            if (binding.tvRepoLanguage.text == "Kotlin") binding.tvRepoLanguage.setTextColor(Color.MAGENTA)
            if (binding.tvRepoLanguage.text == "Java") binding.tvRepoLanguage.setTextColor(Color.RED)
